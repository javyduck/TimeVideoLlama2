...
class ModelArguments:
    ...
    mm_use_time_token: bool = field(default=False)
    tune_time_token: bool = field(default=False)
...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        if 'mistral' in model_args.model_name_or_path.lower():
            ...
            config.mm_use_time_token = model_args.mm_use_time_token
            if model_args.mm_use_time_token:
    ...
    if model_args.version == "v0":
        ...
        try:
            ...
            tokenizer._tokenizer.pad_token = tokenizer._tokenizer.unk_token
            tokenizer.pad_token = tokenizer.unk_token
    ...
    if model_args.vision_tower is not None:
        ...
        try:
            ...
            model.config.tokenizer_padding_side = tokenizer._tokenizer.padding_side
            model.config.tokenizer_model_max_length = tokenizer._tokenizer.model_max_length
